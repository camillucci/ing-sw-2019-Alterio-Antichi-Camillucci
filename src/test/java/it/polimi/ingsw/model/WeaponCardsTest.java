...
class WeaponCardsTest {
    ...
    void whisper() {
        ...
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(0, shoot.getPossibleSquares().size());
        shoot.add(gameBoard.getSquares().get(0));
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(0, shoot.getPossibleSquares().size());
        shoot.doAction();
    ...
    void tractorBeam1() {
        ...
        shoot.add(gameBoard.getSquares().get(10));
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(0, shoot.getPossibleSquares().size());
        shoot.doAction();
        assertEquals(1, p3.getDamage().size());
    ...
    void tractorBeam2() {
        ...
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(1, shoot.getPossibleSquares().size());
        shoot.add(gameBoard.getSquares().get(9));
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(0, shoot.getPossibleSquares().size());
        shoot.doAction();
    ...
    void vortexCannon1() {
        ...
        shoot.add(gameBoard.getSquares().get(7));
        assertEquals(2, shoot.getPossiblePlayers().size());
        assertEquals(0, shoot.getPossibleSquares().size());
        shoot.add(p3);
        assertEquals(0, shoot.getPossiblePlayers().size());
    ...
    void vortexCannon2() {
        ...
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(4, shoot.getPossibleSquares().size());
        shoot.add(gameBoard.getSquares().get(6));
        assertEquals(3, shoot.getPossiblePlayers().size());
        assertEquals(0, shoot.getPossibleSquares().size());
        shoot.add(p3);
        assertEquals(2, shoot.getPossiblePlayers().size());
    ...
    void flamethrower2() {
        ...
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(1, shoot.getPossibleSquares().size());
        shoot.add(gameBoard.getSquares().get(2));
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(0, shoot.getPossibleSquares().size());
        shoot.doAction();
        assertEquals(2, p3.getDamage().size());
    ...
    void flamethrower3() {
        ...
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(2, shoot.getPossibleSquares().size());
        shoot.add(gameBoard.getSquares().get(1));
        assertEquals(0, shoot.getPossiblePlayers().size());
        assertEquals(1, shoot.getPossibleSquares().size());
        shoot.add(gameBoard.getSquares().get(0));
        assertEquals(0, shoot.getPossiblePlayers().size());
