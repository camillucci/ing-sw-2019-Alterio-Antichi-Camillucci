...
class EffectsTest {
    ...
    void moveAndDamage() {
        ...
        Effects.moveAndDamage(p1, Arrays.asList(p2, p3), Arrays.asList(gameBoard.getSpawnAndShopSquare(YELLOW), gameBoard.getSpawnAndShopSquare(AmmoColor.BLUE)), Arrays.asList(1, 0, 0, 0));
        assertEquals(1, p2.getDamage().size());
